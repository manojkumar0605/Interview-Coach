    ...
    <div className="flex items-center justify-center min-h-[70vh]">
      <div className="w-full max-w-md glass-panel p-8 sm:p-10 space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-400">Log in to continue your mock interview coaching</p>
        </div>
        ...
        <div className="text-center text-xs text-slate-400 pt-2">
          ...
          <Link href="/signup" className="text-accent-violetGlow hover:underline font-semibold">
            Sign Up
          </Link>
        </div>
      </div>
